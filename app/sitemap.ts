...
const staticPaths = ["", "/uslugi/almaznoe-burenie", "/uslugi/burenie-betona", "/uslugi/burenie-zhelezobetona", "/uslugi/burenie-kirpicha", "/uslugi/otverstiya-pod-ventilyaciyu", "/uslugi/otverstiya-pod-kanalizaciyu", "/uslugi/produhi-v-fundamente", "/uslugi/burenie-fundamenta", "/ceny", "/works", "/rayony", "/contacts"]
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const paths = [...staticPaths, ventPage.path, "/instrumenty", ...toolsCatalog.map(tool => toolPath(tool.id)), ...blogPaths, ...locationPaths, ...workPaths]
